...
/**
 * Closes a directory handle and sets handle to INVALID_HANDLE_VALUE.
 *
 * @param      handle               Directory handle to close (type: HANDLE).
 */
#define HAPPlatformFileManagerCloseDirFreeSafe(handle) \
    do { \

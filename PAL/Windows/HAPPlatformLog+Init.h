...
/**
 * Logs a Windows error, for example fetched from GetLastError().
 *
 * - The error number will be mapped to a Windows error message string.
 *
 * @param      type                 A log type constant, indicating the level of logging to perform.
 * @param      message              The log message.
 * @param      errorNumber          Windows error number.
